...
import { saveTranscript, getTranscript } from "@/app/actions";
  ...
  useEffect(() => {
    const fetchTranscript = async () => {
      try {
        ...
        const data = await getTranscript(chapterId);
        if (data) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create, edit, or upload a transcript for this chapter
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
